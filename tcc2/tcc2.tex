...
entrada. O conjunto de dados é composto por 82 cartas fornecidas por 
...
\begin{figure}[H]
    ...
    \legend{Fonte: Imagem RGB fornecida por empresa parceira; imagem fotométrica elaborada pelo autor a partir da imagem original (2026).}
\end{figure}
